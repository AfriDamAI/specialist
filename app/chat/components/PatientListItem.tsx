  ...
  return (
    ...
    >
      <div className="relative">
        ...
        <span
          className={`absolute bottom-0 right-0 w-3 h-3 rounded-full border-2 border-white dark:border-gray-950 ${patient.status === 'online'
              ? 'bg-green-500'
      ...
      <div className="flex-1 min-w-0">
        <div className="flex items-center justify-between">
          ...
          {patient.lastMessageTime && (() => {
            const date = new Date(patient.lastMessageTime);
            ...
            return (
              <span className="text-[10px] font-bold text-gray-400 ml-2 shrink-0 uppercase tracking-tighter">
                {label}
              </span>
            );
          })()}
